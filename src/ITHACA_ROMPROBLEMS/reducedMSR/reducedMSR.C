...
reducedMSR::reducedMSR(msrProblem& FOMproblem)    
{
	...
	newton_object_n=newton_msr_n(Nphi_flux+Nphi_prec1+Nphi_prec2+Nphi_prec3+Nphi_prec4+Nphi_prec5+Nphi_prec6+Nphi_prec7+Nphi_prec8, Nphi_flux+Nphi_prec1+Nphi_prec2+Nphi_prec3+Nphi_prec4+Nphi_prec5+Nphi_prec6+Nphi_prec7+Nphi_prec8, FOMproblem);
	newton_object_t=newton_msr_t(Nphi_T+Nphi_dec1+Nphi_dec2+Nphi_dec3, Nphi_T+Nphi_dec1+Nphi_dec2+Nphi_dec3, FOMproblem);
}
...
/// Neutronics terms
	...
	fvecn(i)=lf(0,0)+pf(0,0)-af(0,0)+F3_1(i)+F3_2(i)+F3_3(i)+F3_4(i)+F3_5(i)+F3_6(i)+F3_7(i)+F3_8(i);
	}
...
void reducedMSR::solveOnline(Eigen::MatrixXd vel_now, Eigen::MatrixXd temp_now, Eigen::VectorXd mu_online)
{
	Info<<"\n Starting online stage...\n"<<endl;	
	y.resize(Nphi_u+Nphi_p,1);
	y.setZero();
	w.resize(Nphi_flux+Nphi_prec1+Nphi_prec2+Nphi_prec3+Nphi_prec4+Nphi_prec5+Nphi_prec6+Nphi_prec7+Nphi_prec8,1);
	w.setZero();
