...
namespace ITHACAPOD
{
    ...
    //specialisation:
  template<typename T>
  void PODParameters::read_snapshot(T& snapshot, const Foam::label& i_snap, Foam::word path, Foam::word name) const
  {
  ...
  template void PODParameters::read_snapshot(Foam::volScalarField& snapshot, const Foam::label& i_snap, Foam::word path, Foam::word name) const;
  template void PODParameters::read_snapshot(Foam::volVectorField& snapshot, const Foam::label& i_snap, Foam::word path, Foam::word name) const;
  template void PODParameters::read_snapshot(Foam::volTensorField& snapshot, const Foam::label& i_snap, Foam::word path, Foam::word name) const;
}