...
List < Eigen::MatrixXd > steadyNSturb::turbulence_term1(label NUmodes, label NSUPmodes, label Nnutmodes)
{
...
List < Eigen::MatrixXd > steadyNSturb::turbulence_term2(label NUmodes, label NSUPmodes, label Nnutmodes)
{
	label Csize = NUmodes + NSUPmodes + liftfield.size();
...
void steadyNSturb::projectSUP(fileName folder, label NU, label NP, label NSUP, label Nnut)
{
