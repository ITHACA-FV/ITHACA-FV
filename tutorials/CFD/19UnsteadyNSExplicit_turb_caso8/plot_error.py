...
# plt.gca().xaxis.set_minor_locator(plt.MultipleLocator(2))  # Modifica la distanza tra i minor ticks sull'asse X
# plt.gca().yaxis.set_minor_locator(plt.MultipleLocator(2))  # Modifica la distanza tra i minor ticks sull'asse Y
