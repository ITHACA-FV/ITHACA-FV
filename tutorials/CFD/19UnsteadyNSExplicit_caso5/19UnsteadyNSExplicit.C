...
int main(int argc, char* argv[])
{
    ...
    ITHACAparameters* para = ITHACAparameters::getInstance(example._mesh(),
                             example._runTime());
    int NmodesUout = para->ITHACAdict->lookupOrDefault<int>("NmodesUout", 25);
    int NmodesPout = para->ITHACAdict->lookupOrDefault<int>("NmodesPout", 25);
    int NmodesSUPout = 0;
    int NmodesUproj = para->ITHACAdict->lookupOrDefault<int>("NmodesUproj", 20);
    int NmodesPproj = para->ITHACAdict->lookupOrDefault<int>("NmodesPproj", 20);
    int NmodesSUPproj = 0;
