...
int main(int argc, char* argv[])
{
    ...
    int Nseeds = 50;
    // Create the example object of the EnKF_1DinverseHeatTransfer type
...
//--------
/// \dir  EnKF_1DinverseHeatTransfer Folder of the UQ tutorial 2
/// \file
/// \brief Implementation of state reconstruction in a 1D heat transfer problem 

/// \example EnKF_1DinverseHeatTransfer.C
