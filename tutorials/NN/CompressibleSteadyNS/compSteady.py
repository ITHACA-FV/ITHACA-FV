...
class Net:
    ...
    def read(self):
        ...
        print(pars_test_np_exp.shape)
        print(inp_np_test_U.shape)
        # if(pars_test_np_exp.shape[0] != inp_np_test_U[:,0:self.Nu].shape[0]):
        #     print(pars_test_np_exp.shape[0])
        #m = pars_test_np_exp.shape[0]
        #self.inp_np_test_a = np.append(pars_test_np_exp, inp_np_test_U[:m,0:self.Nu], axis = 1)
